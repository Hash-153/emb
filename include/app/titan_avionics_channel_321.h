/**
 * @file titan_avionics_channel_321.h
 * @brief Mission-Critical Avionics Actuation & Redundant Sensor Channel #321
 * @version 2.4.0
 * @date 2026-08-29
 */

#ifndef TITAN_AVIONICS_CHANNEL_321_H
#define TITAN_AVIONICS_CHANNEL_321_H
...
typedef enum {
    TITAN_CHAN_321_MODE_IDLE = 0,
    TITAN_CHAN_321_MODE_CALIBRATING,
    TITAN_CHAN_321_MODE_ACTIVE,
    TITAN_CHAN_321_MODE_FAILSAFE,
    TITAN_CHAN_321_MODE_DIAGNOSTIC
} titan_chan_321_mode_t;

typedef struct {
    u32_t                      channel_id;
    titan_chan_321_mode_t    mode;
...
#endif /* TITAN_AVIONICS_CHANNEL_321_H */
