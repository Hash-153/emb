/**
 * @file titan_avionics_channel_336.h
 * @brief Mission-Critical Avionics Actuation & Redundant Sensor Channel #336
 * @version 2.4.0
 * @date 2026-08-29
 */

#ifndef TITAN_AVIONICS_CHANNEL_336_H
#define TITAN_AVIONICS_CHANNEL_336_H
...
typedef enum {
    TITAN_CHAN_336_MODE_IDLE = 0,
    TITAN_CHAN_336_MODE_CALIBRATING,
    TITAN_CHAN_336_MODE_ACTIVE,
    TITAN_CHAN_336_MODE_FAILSAFE,
    TITAN_CHAN_336_MODE_DIAGNOSTIC
} titan_chan_336_mode_t;

typedef struct {
    u32_t                      channel_id;
    titan_chan_336_mode_t    mode;
...
#endif /* TITAN_AVIONICS_CHANNEL_336_H */
