/**
 * @file titan_subsystem_006.h
 * @brief Subsystem Telemetry & Power Distribution Unit #006
 */

#ifndef TITAN_SUBSYSTEM_006_H
#define TITAN_SUBSYSTEM_006_H
