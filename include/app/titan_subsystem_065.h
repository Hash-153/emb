/**
 * @file titan_subsystem_065.h
 * @brief Subsystem Telemetry & Power Distribution Unit #065
 */

#ifndef TITAN_SUBSYSTEM_065_H
#define TITAN_SUBSYSTEM_065_H
