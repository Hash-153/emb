/**
 * @file titan_subsystem_074.h
 * @brief Subsystem Telemetry & Power Distribution Unit #074
 */

#ifndef TITAN_SUBSYSTEM_074_H
#define TITAN_SUBSYSTEM_074_H
