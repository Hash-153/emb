/**
 * @file titan_subsystem_116.h
 * @brief Subsystem Telemetry & Power Distribution Unit #116
 */

#ifndef TITAN_SUBSYSTEM_116_H
#define TITAN_SUBSYSTEM_116_H
