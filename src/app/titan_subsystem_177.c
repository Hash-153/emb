/**
 * @file titan_subsystem_177.c
 * @brief Subsystem Controller #177 Logic
 */

#include "app/titan_subsystem_177.h"
#include <string.h>

titan_status_t titan_subsys_177_init(titan_subsys_177_t *sub)
{
    if (!sub) return TITAN_ERROR_NULL_POINTER;
    memset(sub, 0, sizeof(titan_subsys_177_t));
    sub->subsystem_id = 177;
