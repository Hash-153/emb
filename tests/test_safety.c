/**
 * @file test_safety.c
 * @brief Automated Unit Testing Suite for TitanCore-RT SAFETY Subsystem
 */
...
void run_all_safety_tests(void)
{
    test_safety_case_00();
    test_safety_case_01();
    test_safety_case_02();
